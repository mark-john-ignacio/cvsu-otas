...
<div class="content py-4">
    <div class="card card-outline card-primary shadow rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title"><?= isset($id) ? "Update Archive-{$archive_code} Details" : "Submit Document" ?></h5>
        </div>
                ...
                <form action="" id="archive-form">
                    <input type="hidden" name="id" value="<?= isset($id) ? $id : "" ?>">
                        ...
                        <div class="form-group">
                            <label for="curriculum_id">Select Curriculum:</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="title" class="control-label text-navy">Document Title</label>
                                <input type="text" name="title" id="title" autofocus placeholder="Document Title"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="members" class="control-label text-navy">Project Authors</label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="file" id="img" name="img" class="form-control form-control-border"
                                       ...
                                       onchange="displayImg(this,$(this))" <?= !isset($id) ? "required" : "" ?>>
                            </div>
...
<script>
    ...
    $(function () {
        ...
        $('#archive-form').submit(function (e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "admin/archives/save_archive.php?f=save_archive",
